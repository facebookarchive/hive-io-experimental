...
import com.facebook.giraph.hive.output.HiveApiOutputObserver;
 ...
 */
public class HiveApiRecordWriter
    extends RecordWriter<WritableComparable, HiveRecord> {
  /** Logger */
  ...
  public HiveApiRecordWriter(
    ...
    this.observer = NoOpOutputObserver.get();
  }
