...
import static com.facebook.giraph.hive.input.parser.array.BytesParser.parseDouble;
import static com.facebook.giraph.hive.input.parser.array.BytesParser.parseLong;
import static com.facebook.giraph.hive.input.parser.array.BytesParser.parseString;
...
public class BytesParserTest {
  ...
  private Boolean parseBoolean(String s) {
    return BytesParser.parseBoolean(s.getBytes(Charsets.US_ASCII), 0, s.length());
  }
