...
/**
 * Central class for initializing HiveIO
 */
public class HiveIO {
  /** Don't construct */
  private HiveIO() { }
   ...
   *
   * @param conf HiveConf
   * @param silenceLoggers whether to silence various loggers
   */
  public static void init(HiveConf conf, boolean silenceLoggers) {
